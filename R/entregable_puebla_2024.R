...
id_bd_base <- "https://docs.google.com/spreadsheets/d/1M4ifUkX3ULaYoc0gdM2PDC6oEAjUPFAdikTU_jhePFs/edit#gid=485657652"
...
2
bd_encuestas_raw <- openxlsx2::read_xlsx(file = dir_base, sheet = "Puebla", cols = seq.int(1:27)) |> 
